⚡ 智慧校园能耗监测与管理平台 (Smart Campus Energy)

基于 Spring Boot 3 + Vue 3 的全栈企业级能耗监控系统（赛博朋克风格版）
...
创建数据库 energy_你的学号，修改 application.properties 中的数据库账号密码。
...
(这里放三张截图：1. 首页大屏图表 2. 设备列表页 3. 红色告警页)

Developed by [你的名字] | 2025秋软件设计期末项目
